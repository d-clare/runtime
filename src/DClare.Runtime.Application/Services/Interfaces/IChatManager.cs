...
/// <summary>
/// Defines the fundamentals of a service used to manage <see cref="Chat"/>s
/// </summary>
public interface IChatManager
{
    ...
    Task AddOrUpdateAsync(Chat chat, CancellationToken cancellationToken = default);
    ...
    Task<Chat?> GetAsync(string key, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A <see cref="CancellationToken"/></param>
    /// <returns>The matching <see cref="ChatHistory"/>, if any</returns>
    Task<Chat?> GetAsync(string id, string userId, string agentName, CancellationToken cancellationToken = default);
    ...
    IAsyncEnumerable<Chat> ListAsync(string userId, string? agentName = null, CancellationToken cancellationToken = default);
