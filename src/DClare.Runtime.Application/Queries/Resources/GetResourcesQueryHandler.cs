...
public sealed class GetResourcesQueryHandler<TResource>(IResourceRepository repository)
    : IQueryHandler<GetResourcesQuery<TResource>, IAsyncEnumerable<TResource>>
    where TResource : class, IResource, new()
{

    /// <inheritdoc/>
    public Task<IOperationResult<IAsyncEnumerable<TResource>>> HandleAsync(GetResourcesQuery<TResource> query, CancellationToken cancellationToken)
    {
