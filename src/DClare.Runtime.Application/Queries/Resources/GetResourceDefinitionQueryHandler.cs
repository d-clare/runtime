...
public sealed class GetResourceDefinitionQueryHandler<TResource>(IResourceRepository repository)
    : IQueryHandler<GetResourceDefinitionQuery<TResource>, IResourceDefinition>
     where TResource : class, IResource, new()
{

    /// <inheritdoc/>
    public async Task<IOperationResult<IResourceDefinition>> HandleAsync(GetResourceDefinitionQuery<TResource> query, CancellationToken cancellationToken)
    {
