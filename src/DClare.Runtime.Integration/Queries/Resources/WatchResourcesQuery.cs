...
/// <summary>
/// Represents the <see cref="IQuery{TResult}"/> used to watch <see cref="IResource"/>s of the specified type.
/// </summary>
...
[Description("Represents the query used to watch resources.")]
    ...
    where TResource : class, IResource, new()
{
    ...
    /// </summary>
    [Description("The namespace, if any, the resources to watch belong to.")]
    public string? Namespace { get; } = @namespace;

    /// <summary>
    /// Gets a <see cref="List{T}"/> containing the <see cref="LabelSelector"/>s used to filter <see cref="IResource"/>s by.
    /// </summary>
    [Description("Label selectors, if any, used to filter the resources to watch.")]
