...
/// <summary>
/// Represents a chat message content that contains binary data.
/// </summary>
[Description("Represents a chat message content that contains binary data.")]
[DataContract]
public record BinaryPart
    : MessagePart
{
