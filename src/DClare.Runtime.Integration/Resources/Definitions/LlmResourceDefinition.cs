...
/// <summary>
/// Represents the definition of an <see cref="Llm"/> <see cref="Resource"/>.
/// </summary>
[DataContract]
public record LlmResourceDefinition
    : ResourceDefinition
{
    ...
    static LlmResourceDefinition()
    {
        using var stream = typeof(LlmResourceDefinition).Assembly.GetManifestResourceStream($"{typeof(LlmResourceDefinition).Namespace}.{nameof(LlmResourceDefinition)}.yaml")!;
    ...
    /// <summary>
    /// Initializes a new <see cref="LlmResourceDefinition"/>
    /// </summary>
    public LlmResourceDefinition() : base(Instance) { }
