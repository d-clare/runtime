...
/// <summary>
/// Represents the definition of a <see cref="EmbeddingModel"/> <see cref="Resource"/>.
/// </summary>
[DataContract]
public record EmbeddingModelResourceDefinition
    : ResourceDefinition
{
    ...
    static EmbeddingModelResourceDefinition()
    {
        using var stream = typeof(EmbeddingModelResourceDefinition).Assembly.GetManifestResourceStream($"{typeof(EmbeddingModelResourceDefinition).Namespace}.{nameof(EmbeddingModelResourceDefinition)}.yaml")!;
    ...
    /// </summary>
    public EmbeddingModelResourceDefinition() : base(Instance) { }
