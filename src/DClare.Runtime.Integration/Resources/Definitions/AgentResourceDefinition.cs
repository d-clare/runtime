    ...
    : ResourceDefinition
{
    ...
    {
        using var stream = typeof(AgentResourceDefinition).Assembly.GetManifestResourceStream($"{typeof(AgentResourceDefinition).Namespace}.{nameof(AgentResourceDefinition)}.yaml")!;
