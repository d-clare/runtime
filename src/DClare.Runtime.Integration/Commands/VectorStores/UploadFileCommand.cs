...
/// <summary>
/// Represents the command used to upload a file to a vector store.
/// </summary>
[Description("Represents the command used to upload a file to a vector store.")]
[DataContract]
    ...
    : Command
{
    ...
    /// <summary>
    /// Gets/sets the parameters used to configure the upload to perform.
    /// </summary>
    [Description("The parameters used to configure the upload to perform.")]
    [Required]
    [DataMember(Name = "parameters", Order = 2), JsonPropertyName("parameters"), JsonPropertyOrder(2), YamlMember(Alias = "parameters", Order = 2)]
    public virtual required UploadFileCommandParameters Parameters { get; set; }
