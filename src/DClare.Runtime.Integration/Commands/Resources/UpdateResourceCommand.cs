...
/// <summary>
/// Represents the <see cref="ICommand"/> used to update an existing <see cref="IResource"/>.
/// </summary>
...
[Description("Represents the command used to update a resource.")]
public class UpdateResourceCommand<TResource>(TResource resource)
    : Command<TResource>
    where TResource : class, IResource, new()
{

    /// <summary>
    /// Gets the updated <see cref="IResource"/>.
    /// </summary>
