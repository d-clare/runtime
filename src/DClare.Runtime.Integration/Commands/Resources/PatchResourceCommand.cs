...
[Description("Represents the command used to patch a resource.")]
public class PatchResourceCommand<TResource>(string name, string? @namespace, Patch patch, string? resourceVersion)
    : Command<TResource>
